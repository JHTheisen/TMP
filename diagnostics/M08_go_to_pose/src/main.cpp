...
enum class Operation { NORTH_LEVEL, POSE };
...
void finish(bool passed, const char *reason) {
    ...
    snprintf(summary, sizeof(summary),
        ...
        "Reason: %s\nFINAL RESULT: %s\n%s\n",
        operation == Operation::POSE ? "GO TO POSE" : "PRESERVED M07 NORTH / LEVEL",
...
void setup() {
    ...
    Serial.println("M08_go_to_pose: coordinated three-axis poses; preserved M07 startup north/level");
